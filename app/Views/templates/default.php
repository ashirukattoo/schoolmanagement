<?= $this->include('teacher/includes/header') ?>
<?= $this->include('teacher/includes/sidebar') ?>
...
<div class="main-content">
    ...
    <nav class="top-navbar d-flex bg-secondary text-white justify-content-between align-items-center shadow-sm">
        ...
        <h5 class="m-0"><?= $pageTitle ?? 'Admin Dashboard' ?></h5>
...
<?= $this->include('teacher/includes/footer') ?>