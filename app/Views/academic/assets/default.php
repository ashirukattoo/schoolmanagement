<?= $this->include('academic/assets/header') ?>
<?= $this->include('academic/assets/sidebar') ?>
...
<div class="main-content">
    ...
    <nav class="top-navbar d-flex bg-secondary text-white justify-content-between align-items-center shadow-sm">
        ...
        <h5 class="m-0"><?= session()->get('role') ?? 'Teacher\'s Dashboard' ?></h5>
...
<?= $this->include('academic/assets/footer') ?>