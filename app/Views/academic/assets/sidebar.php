...
<div class="sidebar" id="sidebar">
    ...
    <ul class="list-unstyled">
        <li>
          <a href="<?= base_url('academic/index') ?>" class="d-flex align-items-center">
        ...
        <li>
            ...
            <ul class="collapse list-unstyled ps-3" id="studentsSubmenu">
                <?php if(strtolower(session()->get('role'))  === 'academic'): ?>
                    <li><a href="<?= base_url('academic/add/students') ?>">Add</a></li>
                    <li><a href="<?= base_url('academic/students/view'); ?>">View</a></li>
