            ...
            <table id="resultsTable" class="table datatable table-bordered table-striped table-sm">
                <thead class="table-info">
                    <tr>
                        ...
                        <th class="score-mode">Average</th>
                        <th class="grade-mode d-none">Points</th>
                        <th class="grade-mode d-none">Division</th>
                        <th>Remark</th>
                        <th>Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="score-mode"><?= esc($decoded['average']) ?? 0?></td>
                        ...
                        <td>
                            <a href="<?= base_url('admin/report_card/'.$row['eid'].'/'.$row['sid']) ?>" class="btn btn-sm btn-outline-danger"><i class="fas fa-file-pdf"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
