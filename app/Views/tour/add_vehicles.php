    ...
    <div class="container mt-1">
        <div class="card mx-auto p-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <?php } ?>
                <form action="<?= base_url('trans/vehicle') ?>" method="post">
                    <div class="row">
        ...
        <div class="card mx-auto mt-1 p-0 shadow-sm">
            <div class="card-header bg-secondary text-white"><span class="mb-0">Recorded Vehicles</span></div>
            <div class="card-body">
                        ...
                        <?php foreach ($activeRoutes as $s): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="?del_id=<?= $s['rouID'] ?>" class="btn btn-secondary"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                            $count++;
