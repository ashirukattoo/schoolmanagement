...
<div class="sidebar" id="sidebar">
    ...
    <ul class="list-unstyled sidebar-menu">
            ...
            <ul class="submenu list-unstyled ps-3 collapse">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu list-unstyled ps-3 collapse">
                        ...
                        <li><a href="<?= base_url('sms/exam') ?>"><i class="fas fa-envelope me-2"></i> SMS</a></li>
        ...
        <!-- Dashboard -->
        <li>
            <a href="<?= base_url('sms/bulk') ?>" class="d-flex align-items-center">
                <i class="fas fa-envelope me-2"></i><span class="menu-text">Bulk SMS</span>
            </a>
        </li>
        <!-- Logout -->
        <li>
