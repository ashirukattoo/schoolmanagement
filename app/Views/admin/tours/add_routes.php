                     ...
                     ?>
                        <?php foreach ($activeRoutes as $s): ?>
                            <tr>
                                ...
                                <td><?= $s['rouEnd'] ?? 'NIL' ?></td>
                                <td>
                                    <a href="?view_id=<?= $s['rouID'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i> More</a>
                                    <a href="<?= base_url('admin/trans/route/edit/'.$s['rouID']); ?>" class="btn btn-sm btn-info"><i class="fas fa-plus"></i> Station</a>
                                    <a href="<?= base_url('trans/route') ?>?del_id=<?= $s['rouID'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                            $count++;
